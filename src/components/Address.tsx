  ...
  return [
    {
      ...
      render: (data: RelatedTransactionByType) => (
        <a href={`https://explorer.harmony.one/tx/${data.hash}`} target="_blank" className="hover:underline hover:font-medium hover:text-2xl transition-all duration-200 ease-in-out">
        <Text size="small">
